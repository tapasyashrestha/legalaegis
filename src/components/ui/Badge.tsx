    ...
    <div
      className={cn(
        "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2",
        {
          ...
          'border-transparent bg-emerald-100 text-emerald-800 hover:bg-emerald-200/80': variant === 'success',
          'border-transparent bg-amber-100 text-amber-800 hover:bg-amber-200/80': variant === 'warning',
